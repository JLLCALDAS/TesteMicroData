...
uses
  ...
  UWebClienteContato in 'View\UWebClienteContato.pas' {MyWebModule: TWebModule},
  UdtmClienteContato in 'Model\UdtmClienteContato.pas' {dtmClienteContato: TDataModule};
